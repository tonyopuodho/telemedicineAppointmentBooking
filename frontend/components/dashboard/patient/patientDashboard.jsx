         ...
         <div className="flex h-[100vh] w-[100%]">
            <div className="w-[20%] shadow-md h-[100vh] nav top-0 fixed z-10">
               ...
               <ul className="flex flex-col p-6 gap-9">
                ...
                <li><Link to={"/patientDashboard/patient"} className="flex items-center"><FaUserFriends className="text-3xl"/>  <h2 className="ml-4 mt-2 text-xl font-bold">Profile</h2></Link></li>
